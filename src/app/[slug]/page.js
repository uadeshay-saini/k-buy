...
const slug = ({params}) => {
  ...
  return (
    <div>
      main hu slug 
      <h2>{params.slug} </h2>
<h1 className="text-2xl mx-5 font-bold tracking-tight text-gray-900 sm:text-3xl">Basic Tee 6-Pack</h1>

    <nav aria-label="Breadcrumb">
      <ol role="list" className="mx-auto flex max-w-2xl items-center space-x-2 sm:px-6 lg:max-w-7xl lg:px-8">
        <li>
  ...
  <div className="pt-6 md:flex lg:flex">
     ...
     <div className="aspect-h-4 mx-5 mt-5 min-w-600  aspect-w-3  overflow-hidden rounded-lg lg:block">
